...
//		return ResponseEntity.ok(new AuthenticationResponse());
	...
	@PostMapping("/subsUsers")
	private ResponseEntity<AuthenticationResponse>subscribeClient1(@RequestBody AuthenticationRequest authreq){
		UserModel usermodel =new UserModel();
...
//		return ResponseEntity.ok(new AuthenticationResponse());
	...
	private ResponseEntity<?> authenticateClient1(@RequestBody AuthenticationRequest authreq){
		String username=authreq.getUsername();
		String password= authreq.getPassword();
		try {
			authenticates.authenticate(new UsernamePasswordAuthenticationToken(username, password));
